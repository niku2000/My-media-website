...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($name == "" || $email == "" || $category == "" || $title == "") {
        $error_message = "Ju lutem mbushni fushat e kerkuara: Name, Email, Category dhe  Title";
    }
    ...
    if (!isset($error_message)) {
        ...
        $mail->addAddress('niku@localhost', 'Niku');     // Add a recipient
...
<div class="section page">
    <div class="wrapper">
        <h1>Sugjero nje katalog</h1>
        <?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
            echo "<p>Faleminderit per mesazhin,do shoh emailin tend se shpejti!</p>";
        } else {
            if (isset($error_message)) {
                echo "<p class='message'>".$error_message . "</p>";
            } else {
                echo "<p>Nese mendon se mungon dicka me sugjero ndonje gje.</p>";
            }
        ?>
        <form method="post" action="suggest.php">
            ...
            <tr>
                ...
                <td><select id="category" name="category">
                    ...
                    <option value="Books"<?php if (isset($category) && $category == "Books") { echo " selected"; } ?>>Libra</option>
                    <option value="Movies"<?php if (isset($category) && $category == "Movies") { echo " selected"; } ?>>Filma</option>
                    <option value="Music"<?php if (isset($category) && $category == "Music") { echo " selected"; } ?>>Muzike</option>
                </select></td>
            </tr>
            <tr>
